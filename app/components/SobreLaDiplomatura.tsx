	...
	return (
		<div className='text-white flex flex-col w-full justify-center items-center'>
			{faqs.map((faq, index) => (
				<div
					key={index}
					className={`faq-item w-11/12 md:w-4/6 my-4 md:my-0`}
				>
					<div
						className={`faq-question hover:text-pink-500 w-11/12 mx-auto transition duration-300 cursor-pointer border-b mb- lg:mb- md:p-5 flex justify-center gap-5 items-center  ${
							openIndex === index
