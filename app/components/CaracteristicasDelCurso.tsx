...
const CursoItemComponent: React.FC<CursoItem> = ({
	...
	<div className='flex items-center justify-center md:justify-start gap-2 text-firstGreen '>
		<div className='lg:w-12 lg:h-10 w-6 h-6'>{icon}</div>
		<p className='ml-2 lg:leading-loose text-sm lg:text-lg'>
	...
	return (
		<div className='flex flex-col'>
			...
			<div className='flex flex-col md:flex-row w-11/12 mx-auto md:justify-between gap-4'>
				...
				<div className='w-full md:w-2/5 h-auto flex flex-col items-center md:items-start gap-8 justify-evenly px-4 '>
					{cursoData.map(item => (
