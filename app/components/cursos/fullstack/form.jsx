...
export default function FullStackForm() {
	...
	return (
		<>
			<Head>
				<title>Pre inscripción Desarrollo</title>
			</Head>
			<div className='zf-backgroundBg flex flex-col gap-6 w-11/12 lg:w-1/2 mx-auto'>
				<div className='zf-templateWidth text-firstBlue font-semibold'>
					<form
						action='https://forms.zohopublic.com/academianumen/form/PreinscripcinFullStack/formperma/i1jnS669h4c5XAtPxuoXG5xRTz6SLMQCTFn4MbDnVwo/htmlRecords/submit'
						name='form'
						method='POST'
						...
						<div className='zf-templateWrapper'>
							<ul className='zf-tempHeadBdr'>
								<li className='zf-tempHeadContBdr'>
									<h2 className='zf-frmTitle text-3xl mb-6'>
										<em>Pre inscripción Desarrollo</em>
									</h2>
										...
										<div className='zf-tempContDiv border-violet-container rounded-3xl mt-2'>
											...
											>
												<option
													selected={true}
													value='-Select-'
													className='bg-firstBackground text-white'
												>
													-Selecciona un curso-
												</option>
												<option
													className='bg-firstBackground'
													value='Desarrollo&#x20;Web&#x20;Full&#x20;Stack'
												>
													Desarrollo Web Full Stack
												</option>
												<option value='Desarrollo&#x20;Web&#x20;Front&#x20;End'>
													Desarrollo Web Front End
												</option>
												<option value='Desarrollo&#x20;en&#x20;Wordpress'>
													Desarrollo en Wordpress
												</option>
												<option value='Dise&ntilde;o&#x20;UI&#x2f;UX'>
													Dise&ntilde;o UI&#x2f;UX
												</option>
												<option value='HMTL&#x20;y&#x20;CSS'>
													HMTL y CSS
												</option>
												<option value='Desarrollo&#x20;Apps'>
													Desarrollo Apps
												</option>
											</select>
											<p
