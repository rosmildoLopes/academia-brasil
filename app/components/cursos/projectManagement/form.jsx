...
export default function MarketingForm() {
	useEffect(() => {
		...
		script.src =
			'/components/cursospProjectManagement/js/validation.js';
		script.async = true;
	...
	return (
		<>
			<Head>
				<title>Pre inscripción Project Management</title>
			</Head>
			<div className='zf-backgroundBg flex flex-col gap-6 w-11/12 lg:w-1/2 mx-auto'>
				<div className='zf-templateWidth text-firstBlue font-semibold'>
					<form
						action='https://forms.zohopublic.com/academianumen/form/PreinscripcinProjectManagement/formperma/NAOBrk8X-KoUip2719fkC6VyDPoQV9qV9c5zDHYlK8U/htmlRecords/submit'
						name='form'
						method='POST'
							...
							<ul className='zf-tempHeadBdr'>
								<li className='zf-tempHeadContBdr'>
									<h2 className='zf-frmTitle text-3xl mb-6 pl-3'>
										<em>
											Pre inscripción a Project Management
										</em>
									</h2>
								...
								<ul className='space-y-5'>
									<li className='zf-tempFrmWrapper zf-small'>
										...
										<div className='zf-tempContDiv border-violet-container rounded-3xl mt-2'>
											<select
												className='zf-form-sBox w-full placeholder:font-extrabold outline-none'
												name='Dropdown'
												checktype='c1'
											>
												<option
													selected='true'
													value='-Select-'
													className='text-white bg-firstBackground'
												>
													-Select-
												</option>
												<option
												...
												<option
													value='Project Management Asincrónico'
													className='text-white bg-firstBackground'
												>
													Project Management Asincrónico
												</option>
												<option
												...
												<option
													value='Curso preparación PMP en español'
													className='text-white bg-firstBackground'
												>
													Curso preparación PMP en español
												</option>
												<option
